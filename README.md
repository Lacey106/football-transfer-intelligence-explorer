...
The two-dimensional PCA coordinates are used for visual exploration only. Club similarity is calculated using Euclidean distance in the full 64-dimensional Node2Vec embedding space.
